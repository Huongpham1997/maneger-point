...
<div class="container">
    ...
    <?php if(!empty($data['data'])){ 
        ...
        <form action="?url=teacher/update&id=<?= $row['id'] ?>" method="post">
            ...
            <input class="form-control" required name="nameteacher" type="text" placeholder="Tên giáo viên" value="<?= $row['nameteacher']?$row['nameteacher']:'' ?>"><br>
    ...
    <?php }}else{ ?>
        <form action="?url=teacher/addTeacher" method="post">
            <input class="form-control" required name="nameteacher" type="text" placeholder="Tên giáo viên" value=""><br>
