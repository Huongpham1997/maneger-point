...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item action"><a href="#"> Tính điểm trung bình môn cho cả lớp</a></li>
	</ol>
</nav>
<div class="col-md-12">
	<div class="col-md-6">
		<form  action="?url=classStudent/AvegareOfSubjectByStudent&class_id=<?= $_GET['class_id'] ?>" method="post">
			<div class="col-md-8"> 
